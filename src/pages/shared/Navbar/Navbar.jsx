    ...
    const menuItem = <>
        {
            ...
            <li>
                <NavLink to='/' className='rounded-lg px-4'>
                    Home
                </NavLink>
            </li>
        }
        {
            <li>
                <NavLink to='/about' className='rounded-lg px-4'>
                    About
                </NavLink>
            </li>
        }
        {
            <li>
                <NavLink to='/service' className='rounded-lg px-4'>
                    Services
                </NavLink>
            </li>
        }
        {
            <li>
                <NavLink to='/contact' className='rounded-lg px-4'>
                    Contact
                </NavLink>
            </li>
        }
        {
            <li>
                <NavLink to='/login' className='rounded-lg px-4'>
                    Login
                </NavLink>
            </li>
        }
